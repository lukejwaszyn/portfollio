...
└── assets/
    ...
    ├── ground-station/                ← HMI screenshot + hardware
...
Plain HTML, CSS, and vanilla JavaScript. Custom starfield canvas with a galactic band of clustered stars. Fonts from Google (Outfit + JetBrains Mono). Aesthetic pulled from NASA mission control and the Artemis program.
